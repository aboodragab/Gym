...
public class Coachs extends javax.swing.JFrame {
    ...
    private void fillCoachTable() {
    CoachService service = new CoachService();
    ArrayList<Coach> list = service.getAllCoach();
    DefaultTableModel model = (DefaultTableModel) tablCoach.getModel();
    ...
    private void initComponents() {
        ...
        tablCoach = new javax.swing.JTable();
        ...
        tablCoach.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        tablCoach.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "CoachID", "Name", "Age", "Phone", "Addrees", "ExpYears", "PID"
            }
        ) {
        ...
        tablCoach.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tablCoachMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tablCoach);
    ...
    private void btneditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneditActionPerformed
        ...
        try {
            ...
            Coach c=new Coach(selectedCoachId, exe, selectedPersonId, age, name, phone, address);
            CoachService se=new CoachService();
            if(se.editCoach(c)){
    ...
    private void tablCoachMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablCoachMouseClicked
        
        try {
        int rowIndex = tablCoach.getSelectedRow();
        DefaultTableModel model = (DefaultTableModel) tablCoach.getModel();

        selectedCoachId = Integer.parseInt(model.getValueAt(rowIndex, 0).toString());
        
        selectedPersonId = Integer.parseInt(model.getValueAt(rowIndex, 6).toString());
        ...
        txtexp.setText(model.getValueAt(rowIndex, 5).toString());       
        
        } catch (Exception e) {

            System.out.println("Error selecting coach: " + e.getMessage());
        }

    }//GEN-LAST:event_tablCoachMouseClicked
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        if (choice == JOptionPane.YES_OPTION)
            { 
                CoachService se=new CoachService();
                 if(se.removeCoach(selectedCoachId,selectedPersonId)){
    ...
    private javax.swing.JTable tablCoach;
